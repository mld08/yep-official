...
<head>
    ...
    <title>Youth Empowerment Program | Gallery</title>
    <!-- FAVICON -->
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center bg-bluee p-4 mb-4 py-5">
        <h1 class="mb-0 text-white py-5 font-hepidova">GALLERY</h1>
    </div>
        ...
        <div class="row g-4">
            @foreach($galleries as $gallery)
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="{{ asset('storage/' . $gallery->image_path) }}" class="card-img-top" loading="lazy">
                    </div>
                </div>
            @endforeach
        </div>
