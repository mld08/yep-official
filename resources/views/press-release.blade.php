...
<body>
                    ...
                    <ul class="navbar-nav ms-auto nav nav-pills">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/about#information">Information</a></li>
                                <li><a class="dropdown-item" href="/about#program">Program</a></li>
                                <li><a class="dropdown-item" href="/about#venue">Venue</a></li>
                                <li><a class="dropdown-item" href="/about#faqs">FAQs</a></li>
                            </ul>
                        </li>
                        <li class="nav-item"><a href="/thematics" class="nav-link">Thematics</a></li>
                        ...
                        <li class="nav-item mx-4"><a href="/registration/create" class="btn btn-pink px-4">REGISTER!</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div class="d-flex justify-content-center align-items-center bg-dark p-4 mb-4 py-5">
        <h1 class="mb-0 text-white py-5 font-hepidova">PRESS RELEASE</h1>
    </div>

    <div class="container py-5">

        <h2 class="mb-4">Media Advisory</h2>

        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="d-flex align-items-center bg-light p-4 rounded h-100">
                    <!-- Icône PDF -->
                    ...
                    <div class="flex-grow-1">
                        <h5 class="mb-2">Arabic-Media Advisory</h5>
                    </div>
                    <!-- Bouton de téléchargement -->
                    <div>
                        <a href="https://summit.youthconnektafrica.org/wp-content/uploads/2024/11/Arabic-Media-Advisory.pdf"
