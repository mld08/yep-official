                        ...
                        <div class="card h-100 border-0 shadow">
                            <div class="row g-0">
                                ...
                                <div class="col-md-6 d-flex align-items-center">
                                    <div class="card-body">
                                        <h5 class="card-title">Jayden Gill</h5>
                                        <p class="text-muted">Speaker</p>
                                        <p class="card-text">Businesses often become known today through effective
                                            marketing. The marketing may be in the form of a regular news item or half
                                            column society news in the Sunday newspaper.</p>
                                        <div>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card h-100 border-0 shadow">
                            <div class="row g-0">
                                ...
                                <div class="col-md-6 d-flex align-items-center">
                                    <div class="card-body">
                                        <h5 class="card-title">Jack Human</h5>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card h-100 border-0 shadow">
                            <div class="row g-0">
                                ...
                                <div class="col-md-6 d-flex align-items-center">
                                    <div class="card-body">
                                        <h5 class="card-title">Sara Brudt</h5>
                                        <p class="text-muted">Speaker</p>
                                        <p class="card-text">Businesses often become known today through effective
                                            marketing. The marketing may be in the form of a regular news item or half
                                            column society news in the Sunday newspaper.</p>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card h-100 border-0 shadow">
                            <div class="row g-0">
                                ...
                                <div class="col-md-6 d-flex align-items-center">
                                    <div class="card-body">
                                        <h5 class="card-title">Emma Sandoval</h5>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card h-100 border-0 shadow">
                            <div class="row g-0">
                                ...
                                <div class="col-md-6 d-flex align-items-center">
                                    <div class="card-body">
                                        <h5 class="card-title">Harriet Freeman</h5>
